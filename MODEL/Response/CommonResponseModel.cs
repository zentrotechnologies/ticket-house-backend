...
namespace MODEL.Response
{
    ...
    public class PagedListResponse<T> : CommonResponseModel<List<T>>
    {
        public int TotalCount { get; set; }
        public int TotalPages { get; set; }
        public int CurrentPage { get; set; }
    ...
    // Specific response for organizer pagination
    public class OrganizerPagedResponse : PagedListResponse<OrganizerResponse>
    {
    }
}
